...
- [x] Sixth gap-fill batch, hand-authored in-session: 20 entries — merchant +7, scholar +7, innkeeper +6, herbalist skipped this round (gap nearly closed at 25) (`SYN-0885`..`SYN-0904`). 128 hand-authored entries total across six batches.
...
- [ ] Reach 1,000 total entries with balanced archetype distribution (currently 904, see gap table)
- [ ] Build 50-entry stress test corpus (`data/processed/stress_test_corpus.json`) — not started

### Archetype gap (current 904 entries vs. spec target)
...
Merchant/scholar/innkeeper still the biggest gaps, herbalist nearly done (259 entries away from balanced 1,000 overall). Six hand-authored batches in (128 entries total) — same open question as before: keep grinding batches, or call ~900 balanced entries good enough and move to Phase 3 sooner (a judgment call for you, not a technical blocker).
